...
const ClientBookingPage: React.FC = () => {
  ...
  return (
    <Layout>
      <StripeWrapper>
        <div className="booking-container flex flex-col lg:flex-row gap-8 p-8 bg-gray-100 min-h-screen">
          ...
          <div className="w-full lg:w-1/4">
            ...
            <TimeSlots
              ...
              bookedTimes={
                bookedTimes[format(selectedDate, "yyyy-MM-dd")] || []
              }
            />
          </div>
          <div className="w-full lg:w-1/4">
