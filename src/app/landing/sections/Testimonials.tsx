...
const TestomonialsColumn = ({ testimonials, className }: TestimonialsProps) => {
  return (
    <div
      className={twMerge(
      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-description mt-5">
            From intuitive design to powerful features, our app has become a
            favorite among teams of all sizes.
          </p>
        </div>
        <div className="flex justify-center gap-6">
          <TestomonialsColumn testimonials={firstColumn} />
          <TestomonialsColumn
