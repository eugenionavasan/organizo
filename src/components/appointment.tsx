...
export default function Appointment({
  ...
  const [startTime, endTime] = appointmentTimeWindow
    .split(' - ')
    .map((time) => {
  ...
  const isTomorrow =
    appointmentDateObj.toDateString() === tomorrow.toDateString();
  ...
  return (
    <div
      className={`flex justify-between items-center p-4 border-b hover:scale-105" ${
